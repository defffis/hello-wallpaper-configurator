...
- Видео MP4 (при поддержке кодека браузером), иначе WebM; 480p/720p/1080p с сохранением пропорций, 30 fps, без звука. Начальная пауза 0,2 с и финальное удержание 0,6 с. Длинная сторона ограничена 2560 px.
...
**iPhone:** видео необходимо отдельно преобразовать в Live Photo и сохранить в Фото. Затем добавить Live Photo на экран блокировки и включить воспроизведение. iOS 17+ запускает поддерживаемое Live Photo при пробуждении экрана, а не после разблокировки. Совместимость преобразованного файла зависит от конвертера и iOS. Это не экспорт готового нативного Live Photo. [Инструкция Apple](https://support.apple.com/en-us/120734).
