...
Обычный MP4/WebM содержит одно появление и заканчивается готовой надписью. Live Photo использует отдельный профиль около 1 секунды: появление завершается в первой половине, затем финальный кадр удерживается; Bounce отсутствует.
