...
- Live Photo `.livp` для живых обоев iOS: короткая однократная анимация (58 кадров, около 1,93 с) без обратного движения; JPG соответствует финальному кадру, используются `com.apple.photos.variation-identifier = 2`, `LOOP = 0`, общий Content Identifier и timed metadata track `com.apple.quicktime.still-image-time`.
...
Обычный MP4/WebM содержит одно появление и заканчивается готовой надписью. Экспорт Live Photo также использует однократное движение вперёд: надпись появляется и остаётся в финальном состоянии, которому соответствует неподвижный JPG.
